...
{
    public partial class MasterSupplier : System.Web.UI.Page
    {
        ...
        private void BindGridShowroom()
        {
            ...
            {
                string where = string.Format(" where STATUS_SHOWROOM ='SUP' AND {0} like '%{1}%'", ddlSearch.SelectedValue, tbSearchSuppl.Text);
            ...
            {
                string where = string.Format(" where STATUS_SHOWROOM ='SUP'");
