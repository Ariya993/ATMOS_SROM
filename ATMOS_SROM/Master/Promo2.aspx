<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Promo2.aspx.cs" Inherits="ATMOS_SROM.Master.Promo2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divAwal" runat="server">
        <h2>Rubah Status Master</h2>   
        <div id="DivMessage" runat="server" visible="false">
        </div>
        <asp:Button ID="btnDivUploadAll" runat="server" Text="Upload Promo All Showroom" Visible="false" OnClick="btnDivUploadClick" style="display:none" />
        <asp:Button ID="btnDivUploadShr" runat="server" Text="Upload Promo per Showroom" Visible="false" OnClick="btnDivUploadClick" style="display:none" />
        <div id="divUploadPromo" runat="server" style="border: 1px solid black; padding:2px 2px 2px 2px;">
            <b>Upload Article</b><br /><br />
        ...
        <div id="divMain" runat="server" visible="true">
            ...
            <br />
            <asp:DropDownList ID="ddlShowroom" runat="server" AppendDataBoundItems="false" DataTextField="SHOWROOM" DataValueField="VALUE" Visible="false"></asp:DropDownList>
            <br />
            <asp:Button ID="btnDivAllPromo" runat="server" Text="View All Promo" CommandName="allPromo" Visible="false" OnCommand="divPromoClick"/>
            <asp:Button ID="btnDivPromoShr" runat="server" Text="View Promo per Showroom" CommandName="promoSHR" OnCommand="divPromoClick" Visible="false"/>
                ...
                <div id="divAllPromo" runat="server">
                    ...
                    OnRowCommand="gvMainRowCommand" PageSize="10" OnPageIndexChanging="gvMainPageChanging">
                        <Columns>
                                ...
                                <ItemTemplate>
                                    <div>
                                        <asp:ImageButton ID="imgDel" runat="server" CausesValidation="False" CommandName="DeleteRow"
                                            ImageUrl="~/Image/b_drop.png" Text="Delete" OnClientClick="return notifdelete();" Visible="false"/>
                                     </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="CREATED_DATE" HeaderText="Created Date" DataFormatString="{0:dd/MM/yyyy}" />
                        </Columns>
                    </asp:GridView>
                </div>
