<%@ Page Title="Article" Language="C#" UICulture="id" Culture="id-ID" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Article.aspx.cs" Inherits="ATMOS_SROM.Master.Article" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divAwal" runat="server">
        ...
        <div id="divUpload" runat="server">
            ...
            <asp:HyperLink ID="HyperLinkDownload" runat="server" Target="_blank" NavigateUrl="~/Upload/Format Master Article.xlsx">
