...
{
    public partial class srptSales : System.Web.UI.Page
    {
        ...
        protected void btnGenerateClick(object sender, EventArgs e)
        {
            try
            {
                ...
                ReportViewer.LocalReport.ReportPath = string.Format(@"Reports\{0}", "srptSales.rdlc");
                ReportViewer.Visible = true;

                REPORT_DA rptDA = new REPORT_DA();
                List<USP_SRPTSALES> total = rptDA.getSrptSales(startDate, endDate, "Fred Perry");
                ...
                dataSrcReport = new ReportDataSource("srptSales.rdlc", total);
