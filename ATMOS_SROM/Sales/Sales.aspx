...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="panelMain" runat="server">
        <ContentTemplate>
            <asp:Panel ID="panelAwal" runat="server" DefaultButton="btnInput" Style="overflow: auto">
                <iframe id="iframePDF" visible="false" runat="server" style="display: none;"></iframe>
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-3">
                                    <asp:Button ID="btnRetur" Style="min-width: 250px; width: 20%" runat="server" Text="Retur / Penukaran barang penjualan" OnClick="btnReturClick" />

                                </div>
                                <div class="col-lg-3">
                                    <asp:Button ID="btnVoid" Style="min-width: 250px; width: 20%" runat="server" Text="Void" OnClick="btnVoidClick" />

                                </div>
                                <div class="col-lg-3">
                                    <asp:Button ID="btnNoSale" Style="min-width: 250px; width: 20%" runat="server" Text="NO SALE" ToolTip="Tidak ada penjualan barang hari ini" OnClick="btnNoSaleClick" />

                                </div>
                                <div class="col-lg-3">
                                    <asp:Button ID="btnReprintStruck" Style="min-width: 250px; width: 20%" runat="server" Text="Reprint Bon" OnClick="btnReprintStruck_Click" />
                    ...
                    <div class="col-lg-12">
                        <div id="divStore" runat="server">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <label for="" class="col-lg-2" syle="width:auto">
                                        Tanggal     Transaksi :
                                    </label> 
                                    <div class="col-lg-2" syle="width:auto">
                                    ...
                                    <div class="col-lg-1" syle="width:auto">
                             ...
                             <div class="row" id="trMarginSIS" runat="server">
                                 <div class="form-group">
                                      <label for="" class="col-lg-2" syle="width:auto">
                                         Discount Margin :
                                     </label> 
