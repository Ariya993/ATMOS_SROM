...
{
    public partial class SalesCounter : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!(idHeader.Contains("ERROR")))
            {
                ...
                putusDetail.FRETUR = cbRetur.Checked ? "Yes" : "No";
                ...
                putusHeader.TGL_TRANS = tglTrans;// DateTime.Now;//tglTrans;
                ...
                putusHeader.STATUS_HEADER = "prepare";
                putusHeader.SEND_DATE = tglKirim; //DateTime.Now;//tglKirim;
                putusHeader.MARGIN = Convert.ToDecimal(tbMargin.Text);
                putusHeader.FRETUR = cbRetur.Checked ? "Yes" : "No";
