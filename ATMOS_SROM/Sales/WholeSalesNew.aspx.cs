...
{
    public partial class WholeSalesNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //scriptManager.RegisterPostBackControl(this.btnManualIns);
            if (!Page.IsPostBack)
            {
                scriptManager.RegisterPostBackControl(this.btnManualIns);
                ...
                ClearTxtHeader();
                bindCustSO();
                btnManualIns.Text = "Manual Input";
            }
        }
        ...
        protected void bindHeader()
        {
            ...
            if (listTempWhole.Count > 0)
            {
                ...
                if (ddlCustSO.Items.FindByValue(tempWhole.KODE_PEMBELI) != null)
                {
                    ddlCustSO.Items.FindByValue(tempWhole.KODE_PEMBELI).Selected = true;
                }
                lbNamaPembeli.Text = tempWhole.NAMA_PEMBELI;
                ...
                lbKodePembeli.Text = tempWhole.KODE_PEMBELI;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //        SoHeader.QTY = Convert.ToInt32(lblSumQty.Text);//totalQty;
        ...
        protected void UpdateSOWholesale(string namaKasir)
        {
            ...
            if (cekpo == 0)
            {
                ...
                kdbrgDA.deleteStruck(namaKasir);
                bindGrid();
                DivMessage.InnerText = "WholeSale dengan No : " + txtNoSO.Text + " Berahasil di Update";
                DivMessage.Attributes["class"] = "success";
                DivMessage.Visible = true;
                ClearTxtHeader();
        ...
        protected void btnInsShPutus_Click(object sender, EventArgs e)
        {
            ...
            if (!(idHeader.Contains("ERROR")))
            {
                ...
                decimal margin = decimal.Parse(lblMargin.Text);
                ...
                bayarDA.insertPutusDetailFromSO(putusDetail, user, lblnoso.Text);
                #endregion
                ...
                putusHeader.TGL_TRANS = Convert.ToDateTime(date);//tglTrans;
        ...
        protected void gvCloseSo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName.ToLower() != "page")
                {
                    ...
                    {
                        tstDa.UpdateSoWholesalesHeaderStatus(noso, "DONE");
                        bindGridCloseSO();
                        ModalPopupCloseSO.Show();
                    }
                    else if (e.CommandName.ToLower() == "editso")
                    {
                        ...
                        idSOHeaderEdit.Text = Convert.ToString(ListSOHeader.FirstOrDefault().ID);
                        ...
                        //tbNama.Text = ListSOHeader.FirstOrDefault().KODE_CUST;
        ...
        protected void BindEditSoDetail()
        {
            SO_SHOWLESALES_DA tstDa = new SO_SHOWLESALES_DA();
            List<SO_WHOLESALES> listSoDetail = new List<SO_WHOLESALES>();
            string where = string.Format("WHERE NO_SO = '" + lblnoso.Text + "'");
        ...
        protected void gvCloseSo_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                string langQtyReal1 = DataBinder.Eval(e.Row.DataItem, "QTY_REAL_1").ToString();
                string langQtyReal2 = DataBinder.Eval(e.Row.DataItem, "QTY_REAL_2").ToString();
                string langTglReal1 = DataBinder.Eval(e.Row.DataItem, "TGL_KIRIM_1").ToString();
                string langTglReal2 = DataBinder.Eval(e.Row.DataItem, "TGL_KIRIM_2").ToString();
                string NoBon = DataBinder.Eval(e.Row.DataItem, "NO_BON").ToString();
                int QtyReal1 = Convert.ToInt32(langQtyReal1);
                int QtyReal2 = Convert.ToInt32(langQtyReal2);
                ...
                { imgedit.Visible = false; }
                //if (!(langTglReal1 == "01/01/0001 00.00.00" || langTglReal2 == "01/01/0001 00.00.00"))
                //{
                //    imgedit.Visible = false;
                //}
                //if (QtyReal1 > 0 || QtyReal2 > 0)
                //{
                //    imgedit.Visible = false;
                //}
            }
        ...
        protected void btnManualIns_Click(object sender, EventArgs e)
        {
            String IDSOEDIT = "";
            if (idSOHeaderEdit.Text.Trim() != "")
            {
                IDSOEDIT = idSOHeaderEdit.Text.Trim();
            }
            Context.Response.Redirect("WholeSalesManualInput.aspx?IdSO=" + IDSOEDIT);
        }
    }
}