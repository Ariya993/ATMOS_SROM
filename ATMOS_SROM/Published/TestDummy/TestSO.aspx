<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TestSO.aspx.cs" Inherits="ATMOS_SROM.TestDummy.TestSO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PanelPopupCloseSO" runat="server" BackColor="White" CssClass="ModalWindow"
        ...
        <br />
        <asp:TextBox ID ="txtSearchCloseSO" runat="server"></asp:TextBox> &nbsp <asp:Button ID="btnSearchCloseSO" runat="server" Text="Search" OnClick="btnSearchCloseSO_Click" />
        &nbsp
    ...
    <asp:Panel ID="PanelSoToShPutusSrch" runat="server" BackColor="White" CssClass="ModalWindow"
        ...
        <br />
        <asp:TextBox ID ="txtSearchSO" runat="server"></asp:TextBox> &nbsp <asp:Button ID="btnSearchSo" runat="server" Text="Search" OnClick="btnSearchSo_Click" />
            &nbsp <asp:Button ID="btnSearchSoCancel" runat="server" Text="Close" OnClick="btnSearchSoCancel_Click" />
        <br />
        <div class="EU_TableScroll" style="display: block">
...
<%--    <asp:Panel ID="PanelSHPutusIns" runat="server" BackColor="White" CssClass="ModalWindow"
        ...
        <table>
            <tr>
                ...
                <td>
                    : <asp:Label ID="lblnopo" runat="server"></asp:Label> <asp:Label ID="lblNoScan" runat="server" Visible="false"></asp:Label> <asp:Label ID="lblIdHeader" runat="server" Visible="false"></asp:Label> 
                </td>
                <td width="15%"></td>
                <td>
                    NO SO 
            ...
            <tr>
                ...
                <td width="15%"></td>
                 <td colspan="2" align="left">
                    <asp:Button ID ="btnInsShPutusCancel" runat="server" Text="Close" OnClick="btnInsShPutusCancel_Click" />
                </td>
            </tr>
        </table>
             <div class="EU_TableScroll" style="display: block">
                    <asp:GridView ID="gvDetailSO" runat="server" AllowPaging="true" PageSize="20" OnPageIndexChanging="gvDetailSO_PageIndexChanging"
    ...
    <asp:Panel ID="PanelIRetur" runat="server" BackColor="White" CssClass="ModalWindow"
        ...
        <table width="100%" cellspacing="4" >
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tbIReturTglKirim" runat="server" Width="100%" ReadOnly="true"></asp:TextBox>
                    <asp:CalendarExtender ID="CalendarIReturTglKirim" runat="server" Enabled="false" Format="dd-MM-yyyy"
