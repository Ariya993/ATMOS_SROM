<%@ Page Title="Member" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Member.aspx.cs" Inherits="ATMOS_SROM.Master.Member" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divAwal" runat="server">
        ...
        <div id="divMain" runat="server" visible="true">
            ...
            <asp:Button ID="btnMember" runat="server" Text="Create Member" OnClick="btnMemberClick" ToolTip="Membuat Member Baru" />
            <br />
